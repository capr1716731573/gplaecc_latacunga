...
export class ProblemasCiudadanoService {
  url:string=dominio_ws+`/problema_ciudadano`;
  tabla:string='Problemas Ciudadano ';
  ...
  crud(opcion:number,obj_json:any):Observable<any>{
    let url_ws=`${this.url}/`;
